...
- Use Polly for remote-call resilience and retry policy composition.
- Use dependency injection in the CLI composition root for services, resilience policies, and logging.
